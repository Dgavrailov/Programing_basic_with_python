...
for current_group in range(number_of_groups): # ot 1 do number of groups + 1
    current_number_of_climbers = int(input())
    if current_number_of_climbers <= 5:
        mussala_climbers += current_number_of_climbers
...
mussala_percentage = mussala_climbers / total_climbers * 100
